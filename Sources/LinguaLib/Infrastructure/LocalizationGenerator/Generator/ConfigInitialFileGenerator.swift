...
public final class ConfigInitialFileGenerator: ConfigInitialFileGenerating {
  ...
  public init(contentFilesCreator: ContentFileCreatable,
...
extension ConfigInitialFileGenerator {
  public static func make() -> ConfigInitialFileGenerating {
